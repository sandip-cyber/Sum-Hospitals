...
include('func.php');  
include('newfunc.php');
$con=mysqli_connect("sql103.infinityfree.com","if0_38635825","QVrZPXnKPYIW8","if0_38635825_myhmsdb");
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Sum Hospital </a>
                      ...
                      echo "Cancelled by Doctor";
                        ...
                        { ?>
	                        ...
	                        <a href="admin-panel.php?ID=<?php echo $row['ID']?>&cancel=update" 
                              ...
                              <button class="btn btn-danger" onclick="pathadvice.connect()">Call Agent</button>
	                        <?php } else {
